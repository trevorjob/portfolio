    ...
    <section className="parallax">
      <div className="parallax__content absolute top-[10%] sm:top-[16%] lg:top-[24%] w-full mx-auto lg:pl-[38vh] lg:pr-[30vh] xl:pl-96 xl:pr-72 2xl:px-40 3xl:px-60 flex flex-col lg:flex-row items-start z-10">
        <div className="flex-1 lg:mb-0">
          <h1 className="font-medium text-white text-[32px] xs:text-[40px] sm:text-[50px] md:text-[70px] lg:text-[90px] xl:text-[120px] 2xl:text-[160px] leading-tight md:leading-[90px] lg:leading-[110px] 2xl:leading-[140px] text-left md:text-left">
            <span>{'KUMDAN "TREVOR"'}</span>
            <br />
            <span> JOB</span>
          </h1>
          <Position />
        </div>
        <div className="flex-1 flex justify-start lg:justify-end mt-7 sm:mt-16 ml-8 xs:ml-[-4vh] sm:ml-[-17vh] md:ml-[-26vh] lg:mt-10 2xl:mt-0">
